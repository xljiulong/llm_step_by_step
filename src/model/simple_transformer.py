...
n_heads = 16  # number of heads in Multi-Head Attention（有几套头）
...
class PositionalEncoding(nn.Module):
    def __init__(self, d_model, dropout=0.1, max_len=5000):
        ...
        # div_term = 1 / torch.pow(10000, torch.arange(0, d_model, 2).float()/d_model)
...
class Encoder(nn.Module):
    ...
    def forward(self, enc_inputs):
        ...
        # src_mask = (src != self.src_pad_idx).unsqueeze(1) TO CHECK
